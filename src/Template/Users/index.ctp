            ...
            if ($user->id != $authUser['id']) {
                ...
                <div class="single-user row <?php echo $background; ?>-area">
                    ...
                    <div class="small-12 medium-10 columns user-detail">
                        ...
                        <?= $this->Html->link(__('View profile'), ['action' => 'view', $user->id], ['class' => 'red-button']) ?>
                        <?= $this->Html->link(__('Send message'), ['controller' => 'Messages', 'action' => 'view', $user->id], ['class' => 'red-button']) ?>
                    </div>
                </div>
                <?php
                $count++;
