            ...
            <a href="#" data-open="modal-<?php echo $related_user->id; ?>"
               ...
               class="reveal-link">
                <div class="related-user profile-picture" id="related-user-<?php echo $related_user->id; ?>"
                     style="border: solid #000 <?php echo $interest_count; ?>px; background-image: url(/img/<?php echo $related_profile_img; ?>); top: <?php echo rand(0, 500); ?>px; left: <?php echo rand(0, 1000); ?>px;">
