    ...
    <div class="row">
        <div class="columns small-12 medium-8 medium-offset-2">
            ...
            <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
                https://koreroapp.com website (the "Service") operated by Korero ("us", "we", or "our").</p>
            ...
            <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of
                the
                terms then you may not access the Service. This Terms and Conditions agreement for Korero is powered by
                <a
                        href="https://termsfeed.com/">TermsFeed</a>.</p>
            ...
            <p>Korero has no control over, and assumes no responsibility for, the content, privacy policies, or
                practices of
                any third party web sites or services. You further acknowledge and agree that Korero shall not be
            ...
            <p>These Terms shall be governed and construed in accordance with the laws of United Kingdom, without regard
                to
            ...
            <p>If you have any questions about these Terms, please <a href="/pages/contact" class="underline-hover">contact us</a>.</p>
        </div>
    </div>
</div>